...
Default I/O (relative to git_open/):
    ...
    wl      : zenodo_data/wavelengths/wavelengths_swir.npy
...
def main() -> None:
    ...
    ap.add_argument("--wavelengths", default=None,
                    help="wavelengths .npy (default: zenodo_data/wavelengths/wavelengths_swir.npy)")
    ...
    wl_path = Path(args.wavelengths) if args.wavelengths else REPO / "zenodo_data" / "wavelengths" / "wavelengths_swir.npy"
